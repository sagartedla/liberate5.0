...
public class PELPDLLimelite_testng {
	...
	public static void main(String[] args) throws InterruptedException {
        ...
        Thread.sleep(5000);
        //enter surname
        driver.findElementById("creditValidationLIME:surname").sendKeys("testpioremme");
        Thread.sleep(2000);
        driver.findElementById("creditValidationLIME:firstName").click();
        Thread.sleep(2000);
        //enter firstname
        driver.findElementById("creditValidationLIME:firstName").sendKeys("soeperfsd");
        Thread.sleep(5000);
        //enter date if birth
