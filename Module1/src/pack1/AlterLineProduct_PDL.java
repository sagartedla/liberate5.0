...
public class AlterLineProduct_PDL {
        ...
        Thread.sleep(5000);
        //pass account number
        driver.findElementById("customerSearchForm:customerSearchFBTabSet:0:serviceNo").sendKeys("4748241");
        Thread.sleep(5000);
        ...
        //hover over products
        driver.findElement(By.xpath("//span[contains(text(),'Copy/Move')]/./following::span[3]")).click();
        Thread.sleep(2000);
        ...
        Thread.sleep(2000);
        driver.findElement(By.xpath("//select[@id='alterForm:fixedApplicationSource']/./following::select[1]")).sendKeys("14180-DSL - Mega");
        Thread.sleep(2000);
        driver.findElement(By.xpath("//select[@id='alterForm:fixedApplicationSource']/./following::select[1]")).sendKeys("14182-DSL - Mega Max");
        driver.findElement(By.xpath("//input[@value='Accept']")).click();
        Thread.sleep(2000);
       if(driver.findElement(By.xpath("//input[@value='OK']/./preceding::span[4]")).getText().matches("Account has a Pricing Plan which may be affected if you proceed"))
        {
        	String c= driver.findElement(By.xpath("//input[@value='OK']/./preceding::span[4]")).getText();
            Thread.sleep(2000);
            System.out.println(c);
            driver.findElement(By.xpath("//input[@id='alterwarn:okButton']")).click();
            Thread.sleep(2000);
            String d= driver.findElement(By.xpath("//input[@value='OK']/./preceding::span[3]")).getText();
            String e= driver.findElement(By.xpath("//input[@value='OK']/./preceding::span[2]")).getText();
            String f= driver.findElement(By.xpath("//input[@value='OK']/./preceding::span[1]")).getText();
            Thread.sleep(2000);
