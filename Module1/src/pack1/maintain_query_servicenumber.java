...
public class maintain_query_servicenumber {
        ...
        driver.findElement(By.xpath("//*[contains(text(),'Raise Date')]/./preceding::select[1]")).sendKeys("SER-Service Number");
        Thread.sleep(2000);
        //pass subaaccount number
        driver.findElement(By.xpath("//*[contains(text(),'Raise Date')]/./preceding::input[2]")).sendKeys("9164212");
        //clck on search
